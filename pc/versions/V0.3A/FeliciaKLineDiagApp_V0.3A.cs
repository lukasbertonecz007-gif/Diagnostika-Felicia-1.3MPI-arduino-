...
namespace FeliciaKLineDiagApp
{
    ...
    public class MainForm : Form
    {
        ...
        public MainForm()
        {
            Text = "FeliciaDiag V0.3A - Škoda Felicia 1.3 MPI Diagnostika & Konfigurace";
        ...
        public string RefreshPorts()
        {
            try
            {
                ...
                Array.Sort(ports);
                string list = string.Join("|", ports);
                string pref = ports.Length > 0 ? ports[0] : "COM6";
                Js("setPorts", list, pref);
                return list;
            }
            catch (Exception ex)
            {
        ...
        public void Connect(string portName, string baudStr)
        {
            ...
            try
            {
                ...
                Status("Připojeno k " + portName + " (" + baud + " bd). Inicializuji komunikaci...", "good");
                Enqueue("[APP] Připojeno k portu " + portName + " (" + baud + " bd)");
...
<div class=""app"">
    ...
    <div class=""nav"">
        ...
        <div class=""sub"">Verze V0.3A / KW1281 Expert</div>
