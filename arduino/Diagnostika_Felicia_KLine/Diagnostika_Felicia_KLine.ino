...
const uint8_t LED_PIN = 13; // Vestavěná LED na Arduino Nano / Uno
...
void menu() {
  Serial.println();
  Serial.println(F("=================================================="));
  Serial.println(F("Diagnostika Felicia K-line"));
...
void setup() {
  ...
  stopKLineSerialForBitBang();
  Serial.println();
  Serial.println(F("APP_BOOT|Diagnostika_Felicia_KLine|V0.3B"));
  Serial.println(F("Boot OK - Arduino Ready"));
  menu();
}
